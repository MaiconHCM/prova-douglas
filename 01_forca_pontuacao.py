...
def jogar():
    ...
    #definido a pontuação base
    pontos=1000

    #Quantos pontos irá perder a cada erro? eu divido a pontuacao maxima pelo maximo de tentativas.
    custo_erro=pontos/7
    ...
    #calculo da pontuacao linda
    pontos=pontos-(custo_erro*erros)
    print(f'Sua pontuação final foi de:{int(pontos)}')
